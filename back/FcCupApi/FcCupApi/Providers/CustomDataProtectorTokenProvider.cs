...
public class CustomDataProtectorTokenProvider<TUser> : IUserTwoFactorTokenProvider<TUser> where TUser : IdentityUser<long>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomDataProtectorTokenProvider{TUser}"/> class.
    /// </summary>
    ...
    public CustomDataProtectorTokenProvider(IDataProtectionProvider dataProtectionProvider,
    ...
    /// </value>
    public ILogger<CustomDataProtectorTokenProvider<TUser>> Logger { get; }
    ...
    /// </returns>
    /// <remarks>This method will always return false for instances of <see cref="CustomDataProtectorTokenProvider{TUser}"/>.</remarks>
