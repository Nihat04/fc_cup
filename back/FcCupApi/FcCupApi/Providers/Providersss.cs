...
namespace FcCupApi.Providers;

/// <summary>
/// Provides protection and validation of identity tokens.
/// </summary>
/// <typeparam name="TUser">The type used to represent a user.</typeparam>
public class DataProtectorTokenProvider2<TUser> : IUserTwoFactorTokenProvider<TUser> where TUser : IdentityUser<long>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DataProtectorTokenProvider2{TUser}"/> class.
    /// </summary>
    ...
    public DataProtectorTokenProvider2(IDataProtectionProvider dataProtectionProvider,
                                      IOptions<DataProtectionTokenProviderOptions> options,
                                      ILogger<DataProtectorTokenProvider2<TUser>> logger)
    {
    ...
    /// </value>
    public ILogger<DataProtectorTokenProvider2<TUser>> Logger { get; }
    ...
    /// </returns>
    /// <remarks>This method will always return false for instances of <see cref="DataProtectorTokenProvider2{TUser}"/>.</remarks>
